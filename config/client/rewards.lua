...
return {
    npc = {
        enable = true, -- true active rewards on npc, false desactive rewards on npc (on drop)
        clear_pickups = true, -- true to clear pickups drop (clear pickups every 30min)
        list = {
    ...
    vehicle = {
        enable = true, -- true active rewards, false desactive rewards
        list = { -- list of vehicle player can got weapon
            [`polmav`] = true, 
            [`fbi`] = true, 
            [`fib2`] = true, 
            [`police`] = true, 
